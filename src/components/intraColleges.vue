<template>
  ...
  <Navbar></Navbar>
    ...
    <u><h2 class="text-xs-center">Add Other College Events</h2></u>
      ...
      <v-layout row wrap>
        <v-flex>
            <v-dialog ref="dialog" v-model="modal_start" :return-value.sync="date" :close-on-content-click="false" persistent lazy full-width width="290px">
                <v-text-field slot="activator" placeholder="Enter date of the event" class="noticeText" v-model="event.date" prepend-icon="event" readonly></v-text-field>
